...
- Mở *Microsoft Store*.</p>
- Tìm Ubuntu 22.04 LTS.</p>
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/f11187c0-f231-4d9e-8333-c77e2360899a" /></p>
- **Cài đặt** → mở Ubuntu lần đầu → nhập **username** & **password**.</p>
